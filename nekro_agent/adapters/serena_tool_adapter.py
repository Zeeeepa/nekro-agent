...
class MockSerenaAgent:
    ...
    def __init__(self, project_root: str, workspace_id: str = None):
...
class MockProject:
    ...
    def retrieve_content_around_line(self, relative_file_path: str, line: int, 
...
class SerenaToolAdapter:
    ...
    def __init__(self, tool_class: Type, project_root: str = None, workspace_id: str = None):
    ...
    async def apply(self, *args, **kwargs) -> str:
        ...
        try:
            ...
            result = tool_instance.apply(*args, **kwargs)
            return result
...
class SerenaToolRegistry:
    ...
    def get_tool_adapter(self, tool_name: str, project_root: str = None, 
                        workspace_id: str = None) -> SerenaToolAdapter:
        ...
        if adapter_key not in self._adapters:
            ...
            self._adapters[adapter_key] = SerenaToolAdapter(
                tool_class, project_root, workspace_id
            )
        ...
        async def create_tool_method(tool_cls=tool_class):
            async def tool_method(*args, _ctx: AgentCtx = None, **kwargs) -> str:
                try:
                    ...
                    result = await adapter.apply(*args, **kwargs)
                    return result
...
def resolve_relative_path(relative_path: str, project_root: str = None) -> str:
